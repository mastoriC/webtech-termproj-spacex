<template>
    <div class="container text-center py-5">
        ...
        <div class="my-3">
            <a v-for="(l, i) in links" :key="i" :href="l.url" target="_blank" class="d-block d-md-inline-block btn-outline p-3 m-3 text-uppercase text-center font-weight-bold position-relative">
