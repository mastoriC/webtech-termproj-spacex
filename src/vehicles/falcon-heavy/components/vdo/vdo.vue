    ...
    <div>
        ...
        <div class="background vh-100 position-relative pointer">
            <div class="section-inner mx-auto">
                <div class="inner-half col-12 bottom-left text-uppercase text-shadow mx-0 mx-sm-4 mx-md-5 px-3 px-sm-0">
...
<style scoped>
.background {
    background-image: url("https://www.spacex.com/static/images/backgrounds/fh_video-mobile.webp");
...
@media screen and (min-width: 992px) {
    .background {
        background-image: url("https://www.spacex.com/static/images/backgrounds/fh_video.webp");
    }
}
.middle-center {
    position: absolute;
